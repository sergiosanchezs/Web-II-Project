function Calendar(c){
	...
	calendarTemplate = `<div class="calendar-header">
			...
			<span class="btn1 down-btn1"></span>
		</div>
		<div class="months-container">
			<!-- <span class="btn1 previous-btn1"></span> -->
			<p class="JAN">Jan</p>
			<p class="FEB">Feb</p>
			<p class="MAR">Mar</p>
			<p class="APR">Apr</p>
			...
			<p class="NOV">Nov</p>
			<p class="DEC">Dec</p>
			<!-- <span class="btn1 next-btn1"></span> -->
		</div>
	</div>
	...
	let prevBtn = calendar.find('.prev-btn1');
	let nextBtn = calendar.find('.next-btn1');
...
// year selector
	yearSpinner.find('.up-btn1').on('click', rollDown);

	yearSpinner.find('.down-btn1').on('click', rollUp);
